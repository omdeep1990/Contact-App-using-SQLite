...
public class DatabaseAdapter {
    ...
    private String sqlQuery = "CREATE TABLE "+TABLE_NAME+" ("+ROW_ID+" "+"INTEGER PRIMARY KEY AUTOINCREMENT"+", "+FIRST_NAME+" text"+", "+LAST_NAME+" text"+", "+IMAGE+" text"+", "+CONTACT_NUMBER+" INTEGER"+", "+EMAIL_ID+" text"+", "+ADDRESS+" text"+")";
    ...
    public void insertData(Context context, String firstName, String lastName, String image, String contactNumber, String emailId, String address){
    ...
    public Cursor getAllData(){
        String[] colList = new String[]{ROW_ID, FIRST_NAME, LAST_NAME, IMAGE, CONTACT_NUMBER, EMAIL_ID, ADDRESS};
    ...
    public void updateRecord(Context context, String firstName, String lastName, String image, String rowId, String number, String email, String address){
        ContentValues contentValues = new ContentValues();
        contentValues.put(FIRST_NAME, firstName);
        contentValues.put(LAST_NAME, lastName);
